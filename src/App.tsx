...
import { person,trophy,flask } from 'ionicons/icons';
...
const App: React.FC = () => (
  <IonApp>
    <IonReactRouter>
      <IonTabs>
        <IonRouterOutlet>
          <Route path="/summary" component={Tab1} exact={true} />
          <Route path="/work" component={Tab2} exact={true} />
        ...
        <IonTabBar slot="bottom">
          ...
          <IonTabButton tab="tab2" href="/work">
            <IonIcon icon={trophy} />
